...
# ApplicantGuardian, Student, StudentGuardian, and AcademicEnrollment are
# deliberately not registered here. The Django admin site's own is_staff gate
# would be a second, unguarded mutation path outside
